...
use App\Filament\Resources\ServiceQuestResource\Pages;
use App\Filament\Resources\ServiceQuestResource\RelationManagers;

class ServiceQuestResource extends Resource
{
    protected static ?string $model = ServiceQuest::class;
    ...
    {
        return [
            'index' => Pages\ListServiceQuests::route('/'),
            'create' => Pages\CreateServiceQuest::route('/create'),
            'edit' => Pages\EditServiceQuest::route('/{record}/edit'),
        ];
    }    
}
